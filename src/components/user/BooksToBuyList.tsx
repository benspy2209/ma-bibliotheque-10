      ...
      <CardContent className="pt-6">
        <div className="mb-6 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-md border border-amber-200 dark:border-amber-800">
          <p className="text-sm text-amber-700 dark:text-amber-200">
            <strong>Comment soutenir BiblioPulse :</strong> En cliquant sur les liens Amazon ci-dessous, vous générez une 
            commission d'affiliation (identifiant: {AMAZON_AFFILIATE_ID}) sur vos achats sans aucun coût supplémentaire pour vous. 
            Cette commission s'applique également à tout achat effectué dans les 24 heures suivant votre clic, 
            pas uniquement pour le livre concerné.
          </p>
        </div>
