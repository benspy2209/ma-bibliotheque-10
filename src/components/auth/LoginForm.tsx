      ...
      if (authMode === 'login') {
        ...
        if (error) {
          ...
          if (error.message.includes('confirmation email') || error.message.includes('sending')) {
            ...
            setEmailSentMessage("L'inscription a réussi, mais l'envoi de l'email de confirmation a échoué en raison d'un problème de configuration DNS. Veuillez contacter l'administrateur.");
            toast({
        ...
        <form onSubmit={handleSubmit} className="space-y-4 w-full max-w-sm">
          ...
          <Alert className="mt-4">
            <AlertDescription className="text-xs">
              Note: Des problèmes de configuration DNS ont été détectés sur le domaine bibliopulse.com. 
              La confirmation par email peut ne pas fonctionner correctement tant que ces problèmes ne sont pas résolus.
            </AlertDescription>
          </Alert>
        </form>
      </TabsContent>
