...
export const roadmapFeatures: RoadmapFeature[] = [
  ...
  {
    name: "Page profil utilisateur",
    description: "Page dédiée au profil utilisateur avec accès à toutes les informations personnelles",
    status: "completed",
    completionDate: "28 mars 2025",
    technical_details: "Interface utilisateur responsive, gestion des informations personnelles, validation des formulaires"
  },
  {
