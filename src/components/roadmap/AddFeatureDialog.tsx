  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="pulse" className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-10 text-xs md:text-sm px-2 py-1 md:px-3 md:py-2 shadow-lg">
          <Plus className="h-3 w-3 md:h-4 md:w-4 mr-1" />
          Ajouter
        </Button>
      </DialogTrigger>
      <DialogContent className="max-w-[95vw] w-full sm:max-w-[600px] p-3 sm:p-6 max-h-[90vh] overflow-y-auto">
        <DialogHeader>
