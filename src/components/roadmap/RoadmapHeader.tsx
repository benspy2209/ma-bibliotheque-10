...
const RoadmapHeader = () => {
  return (
    <>
      <header className="mb-6 md:mb-10 text-center w-full max-w-full px-1">
        <h1 className="text-xl md:text-4xl font-bold mb-3 md:mb-4 break-words">Roadmap Technique</h1>
        <p className="text-base md:text-xl text-muted-foreground max-w-full mx-auto">
          Découvrez notre vision technique et les fonctionnalités que nous développons pour BiblioPulse
        </p>
      </header>

      <div className="flex flex-wrap justify-center items-center gap-2 md:gap-6 mb-8 md:mb-10 max-w-full">
